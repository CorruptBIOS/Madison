...
When the server has been opened by the IA member+, you must follow the On-Duty procedure (found in the "Policies" section of this website), and set a Peace timer for 10 minutes (600 seconds) by using the command:
...
When you're in-game on Main Staff Duties, you must do the following:

{% stepper %}
{% step %}
### Join the in-game server

Join the server you were asked to staff.
{% endstep %}

{% step %}
### Set a peace timer

Run the peace timer command to give roleplayers a 10-minute cooldown.
...
{% step %}
### Spawn a staff vehicle

Spawn a car with the staff livery for visibility and consistency.
{% endstep %}
...
Wait around 2–3 minutes after this announcement.
{% endstep %}
...
Wait around 30 seconds after this announcement.
{% endstep %}
