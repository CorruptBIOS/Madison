...
1. Open the moderation panel in your browser (found in Staff Info).
2. Under "Create a new log", search the username.
3. When their profile appears, fill out the form — provide full detail for the reason.
4. Click Create.
5. Verify the user’s previous moderation history (displayed to the side).
