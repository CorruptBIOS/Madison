...
```
!warn 1111181789340368898 - Rule 7 - Bot Commands in General Chat.
```
{% endstep %}
...
```
!mute 1111181789340368898 2h Rule 3 - Instigating Drama after being asked to stop.
```
{% endstep %}
...
```
!kick 1111181789340368898 Carrying on drama after being muted.
```
{% endstep %}
...
{% code title="Temp ban command" %}
```
!ban [USER/ID] [LENGTH] [REASON]
```
{% endcode %}
...
```
!ban 467387236963450883 7d Carrying on drama after being kicked.
```
{% endstep %}
...
```
!ban 467387236963450883 Mass Spamming.
```
{% endstep %}
{% endstepper %}
