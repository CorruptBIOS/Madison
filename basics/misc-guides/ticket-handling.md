...
Scroll to the top of the ticket to see what the user wishes to discuss.

* If it's clear what information they want, reply with everything they need.
* If it's not clear, politely request clarification.
{% endstep %}

{% step %}
### Close the interaction properly

Once the person has been assisted, ask if there is anything else they need help with.

* If they say there isn't, you may close the ticket.
* If there is something else, assist them and then repeat the closing statement.
{% endstep %}
{% endstepper %}
...
<summary>Why was I kicked or banned?</summary>
...
<summary>How do I partner?</summary>
...
<summary>What if a member is trolling via the ticket system?</summary>
...
<summary>Can I request a higher-up for any reason?</summary>
